...
|-------|------|---------|------|
| _Твой домен (напр. Machine Learning)_ | _PACK-my-domain_ | _MD_ | _c:/Users/Денис/projects/github/PACK-my-domain/pack/my-domain/_ |
...
| Правило (глобальное) | `rule` | `c:/Users/Денис/projects/github/CLAUDE.md` | Строки |
