...
Источник сценария: c:/Users/Денис/projects/github/CLAUDE.md → Протокол Day-Close

## Контекст

- **WeekPlan:** c:/Users/Денис/projects/github/DS-strategy/current/WeekPlan W*.md (последний по дате)
- **MEMORY:** ~/.claude/projects/c--Users-------projects-github/memory/MEMORY.md
- **Exocortex backup:** c:/Users/Денис/projects/github/DS-strategy/exocortex/
...
```bash
# Для КАЖДОГО репо в c:/Users/Денис/projects/github/:
git -C c:/Users/Денис/projects/github/<repo> log --since="today 00:00" --oneline --no-merges
```

- Пройди по ВСЕМ репозиториям в `c:/Users/Денис/projects/github/`
...
Скопируй актуальные файлы в `c:/Users/Денис/projects/github/DS-strategy/exocortex/`:

```bash
# Корневой CLAUDE.md
cp c:/Users/Денис/projects/github/CLAUDE.md c:/Users/Денис/projects/github/DS-strategy/exocortex/CLAUDE.md

# Memory (Слой 3)
cp ~/.claude/projects/c--Users-------projects-github/memory/MEMORY.md c:/Users/Денис/projects/github/DS-strategy/exocortex/MEMORY.md
cp ~/.claude/projects/c--Users-------projects-github/memory/*.md c:/Users/Денис/projects/github/DS-strategy/exocortex/
```
