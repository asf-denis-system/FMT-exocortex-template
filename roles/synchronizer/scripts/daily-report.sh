...
LOG_DIR="c:/Users/Денис/logs/synchronizer"
STRATEGY_DIR="c:/Users/Денис/projects/github/DS-strategy"
...
STRATEGIST_LOG="c:/Users/Денис/logs/strategist/$DATE.log"
...
"
        if echo "$warnings" | grep -q "push failed" 2>/dev/null; then
            report+="- **push failed:** Mac был оффлайн. Запусти \`cd c:/Users/Денис/projects/github/DS-strategy && git pull --rebase && git push\`
"
        fi
    else
        report+="
